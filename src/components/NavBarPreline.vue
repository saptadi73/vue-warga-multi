<template>
    <div>
        <header class="z-0 relative flex flex-wrap sm:justify-start sm:flex-nowrap w-full bg-white text-sm py-3 dark:bg-neutral-800">
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <img src="../assets/orang_peci.jpg" class="h-10 w-10 outline-1 ml-8 outline-black rounded-full">
            </a>
            </div>
