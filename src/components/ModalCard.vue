  ...
  <div>
    ...
    >
      ...
      >
        ...
        >
          <div
            class="bg-gradient-to-r from-purple-600 to-purple-50 flex justify-between items-center py-3 px-4 border-b dark:border-neutral-700"
          >
            <h3
              id="hs-scale-animation-modal-label"
              class="font-bold text-white font-Montserrat"
            >
              {{ title }}
            </h3>
            <button
          ...
          <div class="p-4 overflow-y-auto">
            <p class="mt-1 text-gray-800 font-Poppins">
              {{message_modal}}
            </p>
          </div>
          <div
