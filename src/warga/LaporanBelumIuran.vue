      ...
      <div id="card2" class="">
        ...
        >
          <p class="mt-1 text-sm text-gray-500 dark:text-neutral-500">
            Laporan Data Keluarga yang Belum Menyetorkan Iuran Bulan Tertentu
          </p>
        </div>
      </div>
    </div>
            ...
            >
              ...
              <tbody>
                ...
                >
                  ...
                  >
                    {{ resultku.warga[0].nama }}
                  </td>
                  <td class="px-6 py-4">{{ resultku.blok.blok }}</td>
                  <td class="px-6 py-4">{{ resultku.no_rumah }}</td>
                </tr>
              </tbody>
            </table>
          </div>
