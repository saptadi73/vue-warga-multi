  ...
  <div>
      ...
      <div id="card1" class="">
        ...
        >
          <p class="mt-1 text-sm text-gray-500 dark:text-neutral-500">
            Hasil Pengisian Jenis/Type Warga yang sudah ada tertera di table
            bawah
          </p>
        </div>
      </div>
    ...
    <div>
      ...
      >
          ...
          <div>
            <div id="hs-datatable-filter" class="flex flex-col">
              ...
              <div class="flex items-center mt-4">
                ...
                >
                  Terhitung <span>{{ filteredPekerjaan.length }}</span> Jenis/Type Warga
                </div>
              </div>
            </div>
          </div>
        ...
        >
          <p class="mt-1 text-sm text-gray-500 dark:text-neutral-500">
            Pengisian Jenis/Type Warga untuk pendataan
          </p>
        </div>
      </div>
    </div>
...
async function addPekerjaan() {
  const url = `${BASE_URL}warga/tambah/type`;
...
function bukaModal(id,pekerjaan) {
  ...
  ModalTitle.value = 'Delete Jenis/Type Warga';
  ModalMessage.value = 'Anda yakin ingin menghapus Type/Jenis ' + pekerjaan + ' ini?';
...
async function deletePekerjaan() {
  const url = `${BASE_URL}warga/hapus/type`;
  formValues.value.id = parseInt(formValues.value.id);
  console.log(formValues.value);
...
function bukaModalInput(id,pekerjaan) {
  ...
  ModalInputMessage.value = 'Silakan isi perubahan jenis/type warga ' + pekerjaan +' yang sudah ada';
