      ...
      <div id="card1" class="">
        ...
        >
          <p class="mt-1 text-sm text-gray-500 dark:text-neutral-500">
            ...
            bawah, Refresh halaman ini jika belum ada update
          </p>
        </div>
      </div>
    </div>
          ...
          <div>
            <div id="hs-datatable-filter" class="flex flex-col">
              ...
              <div class="flex items-center mt-4">
                ...
                >
                  Terhitung
                  <span>{{ filteredPekerjaan.length }}</span> Jenis/Type Warga
                </div>
              </div>
            </div>
          </div>
...
function bukaModal(id, pekerjaan) {
  ...
  ModalMessage.value =
    "Anda yakin ingin menghapus Type/Jenis " + pekerjaan + " ini?";
...
function bukaModalInput(id, pekerjaan) {
  ...
  ModalInputMessage.value =
    "Silakan isi perubahan jenis/type warga " + pekerjaan + " yang sudah ada";
