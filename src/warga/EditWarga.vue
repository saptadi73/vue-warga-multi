  ...
  export default {
    ...
    methods: {
      ...
      async addWarga() {
        ...
        const url = BASE_URL + "warga/update/warga/" + uuidkk;
      ...
      async findKK() {
        ...
        await axios
          ...
          .then((response) => {
            ...
            this.$refs.nama.value = this.namaKK;
            this.$refs.nik.value = this.hasilFindKK.nik;

            this.$refs.jk.value = this.jenisKelamin(this.hasilFindKK.jenis_kelamin);
            this.$refs.tempat_lahir.value = this.hasilFindKK.tempat_lahir;
            const tanggal_lahir_saya = new Date(this.hasilFindKK.tanggal_lahir);
            this.$refs.tanggal_lahir.value = this.formatTanggalLagi(tanggal_lahir_saya);

            this.$refs.type.value = this.hasilFindKK.id_type;
            this.$refs.pekerjaan.value = this.hasilFindKK.id_pekerjaan;
