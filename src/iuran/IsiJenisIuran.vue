      ...
      <div id="card1" class="">
        ...
        >
          <p class="mt-1 text-sm text-gray-500 dark:text-neutral-500">
            Hasil Pengisian dan Daftar Jenis Iuran yang sudah ada tertera di table
            bawah
          </p>
        </div>
      </div>
                    ...
                    <table class="">
                      ...
                      >
                        <tr>
                          ...
                          <th class="py-3 px-4 text-xs font-normal">Keterangan</th>
...
async function addPekerjaan() {
  ...
  formValues.value = { nama: nama_pekerjaan, iuran: iuran, keterangan: keterangan, id_tenant: id_tenant };
  try {
...
function bukaModal(id,pekerjaan) {
  ...
  ModalMessage.value = 'Anda yakin ingin menghapus iuran ' + pekerjaan + ' ini?';
