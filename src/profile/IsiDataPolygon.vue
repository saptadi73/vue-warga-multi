    ...
    <div class="p-5 w-[85vw] bg-white border shadow-sm rounded-xl">
        ...
        <div class="mt-8 md:w-[40vw]">
          <div class="flex items-center">
            ...
            <div class="flex rounded-lg shadow-sm">
              ...
              />
              <span
                class="material-icons shadow-sm p-2 cursor-pointer text-white bg-slate-700"
                >location_on</span
              ><i
                class="lni lni-refresh-circle-1-clockwise shadow-sm p-2 cursor-pointer bg-purple-400 rounded-e-lg text-lg"
              ></i>
            </div>
          </div>
        </div>
      ...
      >
        <p class="mt-1 text-sm text-gray-500 dark:text-neutral-500">
          Pengisian data polygon berapa titik-titik GPS pada batas-batas wilayah
        </p>
      </div>
    </div>
